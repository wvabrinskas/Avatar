#
#  Be sure to run `pod spec lint WVCheckMark.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.description  = "Randomly generated user Avatar images using CoreGraphics and Swift."

  s.homepage     = "https://github.com/wvabrinskas/Avatar.git"
  ...
  s.source       = { :git => "https://github.com/wvabrinskas/Avatar.git" , :tag => "#{s.version}" }
